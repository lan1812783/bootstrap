...
local screen_lock_cmd = "i3lock -c 000000"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            volume_widget({card = 0, widget_type = "icon"}),
            battery_widget({
                display_notification = true,
                warning_msg_title = os.getenv("USER") ..", we have a problem",
            }),
            logout_menu_widget({
                onlock = function() awful.spawn.with_shell(screen_lock_cmd) end,
            }),
            s.mylayoutbox,
        },
    }
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "q", function() awful.spawn.with_shell(screen_lock_cmd) end,
              {description = "quit awesome", group = "awesome"}),
    ...
    awful.key({}, "XF86AudioLowerVolume", function() volume_widget.dec() end,
              {description = "decease volume", group = "custom"}),
...
-- Add customizations.
-- Gap size between clients
beautiful.useless_gap = 5
-- Spawn xss-lock so that the screen is locked before laptop suspends
awful.util.spawn("xss-lock --transfer-sleep-lock -- " .. screen_lock_cmd .. " --nofork")
